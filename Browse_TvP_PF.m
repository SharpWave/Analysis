...
load ('TvP.mat','MeanT','MeanI','outT','outI','nAFT','nAFI','Tcent','Icent','ClosestT');

load('PlaceMapsIC.mat','SpatialI','FT','TMap','pval');
...
load('PlaceMaps.mat','SpatialI','FT','TMap','pval');
...
for i = 1:length(MeanT)
    ...
    subplot(2,2,3);imagesc(TMap{i});axis equal;
